...
function HomePage() {
  return (
    <>
      <Head>
        <title>{`fast calc`}</title>

        <meta
          name="description"
          content="Unlock the Power of Privacy with Fast Calc - Your Calculator and Secret Locker for Photos, Videos, Movies, and More."
        />
      </Head>
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1626266061368-46a8f578ddd6?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxjYWxjdWxhdG9yfGVufDB8fHx8MTY5MDczNDQwNHww&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Unlock the Power of Privacy with Fast Calc - Your Calculator and Secret Locker for Photos, Videos, Movies, and More.`}
            </Text>
            <Box
